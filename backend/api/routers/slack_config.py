...
Reads and writes backend/policy/runtime/slack_config.yaml. Changes are picked up by the
Gmail AI worker on the next assessment without a restart.
"""
...
_CONFIG_FILE = RULES_RUNTIME / "slack_config.yaml"
