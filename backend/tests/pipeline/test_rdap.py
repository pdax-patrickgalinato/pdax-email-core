...
into workers/pipeline/sender.py — Web Reputation (TMES policy parity). All HTTP
...
from workers.pipeline import policy, sender
from workers.pipeline.rdap_client import _sanitize_domain, domain_age_days, domain_rdap_summary
