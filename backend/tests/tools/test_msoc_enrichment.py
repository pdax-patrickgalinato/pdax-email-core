...
from cli.eml_analysis_agent import _SYSTEM_PROMPT, render_markdown
...
def test_normalize_list_items_strips_leading_numbers():
    from cli.eml_analysis_agent import _normalize_analysis, _normalize_list_items
...
def test_render_markdown_does_not_double_number_actions():
    from cli.eml_analysis_agent import render_markdown
    analysis = {
...
def test_parse_eml_attaches_landing_and_osint_when_enabled():
    from cli.eml_analysis_agent import parse_eml
    ...
    try:
        with mock.patch("workers.pipeline.landing_fetch.analyze_urls", return_value=fake_landing), \
             mock.patch("workers.pipeline.rdap_client.domain_rdap_summary", return_value=fake_rdap):
...
def test_call_agent_retries_on_finish_reason_length():
    ...
    from cli.eml_analysis_agent import call_agent
