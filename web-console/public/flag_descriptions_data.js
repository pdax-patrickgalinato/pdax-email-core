// AUTO-GENERATED by python -m backend.cli.build_flag_descriptions — do not edit by hand.
// Source: backend/report.py's _FLAG_DESCRIPTIONS / _FLAG_PREFIX_DESCRIPTIONS.
window.SEG_FLAG_DESCRIPTIONS = {
  "exact": {
    "learned_benign": "An analyst previously marked mail from this sender or domain as not malicious. That is channel trust — this copy is still analyzed, and a first-time payment/access request to this recipient can still score.",
    ...
    "profile_vpn_new": "This copy's originating hop looks like a VPN or proxy, but prior CLEAN/LOW mail from this sender never did.",
    "profile_hosting_new": "This copy originates from cloud/VPS hosting; this sender usually uses ESP or ISP infrastructure.",
    ...
    "profile_auth_regression": "SPF failed on this copy although this sender usually passes SPF.",
    "profile_mailbox_new": "This copy was delivered to a mailbox this sender has not written to in CLEAN/LOW history.",
    "profile_hour_unusual": "This copy's Date hour is outside the hours this sender usually sends CLEAN/LOW mail.",
  ...
  "prefix": {
    ...
    "campaign_hash": "This attachment hash is shared with campaign {value} — the same payload appeared in other scanned copies.",
    "campaign_url_path": "This landing URL is shared with campaign {value} — the same destination appeared in other scanned copies.",
    "campaign_url_host": "This URL host is shared with campaign {value} — other senders used the same destination domain.",
    "campaign_content": "This message template is shared with campaign {value} — near-identical body text appeared in other scanned copies.",
    ...
    "campaign_mixed": "This copy shares multiple pivots with campaign {value}.",
