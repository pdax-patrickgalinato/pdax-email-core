...
# Fallback only — production loads this from backend/policy/detection/banned_extensions.txt
...
# backend/policy/detection/weights.yaml (data, not hardcoded, per claude.md's convention) with
