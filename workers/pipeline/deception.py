...
Data-driven via backend/policy/identity/trusted_platforms.yaml + backend/policy/identity/impersonation_brands.txt.
...
from backend.stores.lists import impersonation_brands, trusted_platforms
